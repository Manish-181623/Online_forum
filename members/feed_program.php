...
<?php  
									...
									$post_query = $conn->query("select * from post LEFT JOIN members on post.member_id = members.member_id where topic='PROGRAMMING' order by post_id DESC");
                              ...
                              ?></strong></td>
                                 ...
                                 <?php if($post_row['member_id']==$session_id){ ?>
